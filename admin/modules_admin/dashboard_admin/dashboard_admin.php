        ...
        <div class="main__cards">
            <div class="card">
                ...
                <div class="card_inner">
                    <p class="text-primary-p">Bệnh nhân đến khám trong tháng này</p>
            ...
            <div class="card">
                ...
                <div class="card_inner">
                    <p class="text-primary-p">Số lượng phản hồi</p>
...
<script src="./modules_admin/dashboard_admin/chart_dashboardAdmin.js"></script>