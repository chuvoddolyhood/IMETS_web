...
<section class="home" id="home">
    ...
    <div class="image">
        ...
        <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_olluraqu.json"  background="transparent"  speed="1"   loop  autoplay></lottie-player>
    </div>
...
<div class="counter-container">
    ...
    <span>Bác sĩ và các chuyên gia</span>
</div>
...
<div class="counter-container">
    ...
    <span>Giường bệnh nội & ngoại trú</span>
</div>
    ...
    <div class="container-mailbox">
        ...
        <form id="myForm">
            ...
            <div class="form-group-mailbox">
                ...
                <input id="email" type="text" placeholder="Nhập địa chỉ Email">
            </div>
	...
	<script type="text/javascript">
        function sendEmail() {
            ...
            if (isNotEmpty(name) && isNotEmpty(email) && isNotEmpty(subject) && isNotEmpty(body)) {
                $.ajax({
                   url: './modules_client/main/sendEmail.php',
                   method: 'POST',
                   dataType: 'json',
                   data: {
                       name: name.val(),
