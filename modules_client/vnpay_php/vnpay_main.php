<?php 
    ...
    // echo $ID_Appointment;
    $sql_prescription = "SELECT ID_Prescription, Patient_Pay FROM presciption WHERE ID_Appointment =$ID_Appointment";
    $query_prescription = mysqli_query($conn, $sql_prescription);
    $rows_prescription = mysqli_fetch_array($query_prescription);
    $ID_Prescription = $rows_prescription['ID_Prescription'];
?>
            ...
            <div class="table-responsive">
                <form action="./vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="order_type" name="order_type" type="hidden" value="billpayment"/>
                    </div>
                    <div class="form-group">
                        <label for="order_id">Mã hóa đơn</label>
                        <input class="form-control" id="order_id" name="order_id" type="text" value="<?php echo $ID_Prescription ?>"/>
                    </div>
                    <div class="form-group">
                        <label for="amount">Số tiền</label>
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $rows_prescription['Patient_Pay'] ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="cbo_inv_type" name="cbo_inv_type" class="form-control" value="I" type="hidden"/>
                    </div>
                    <div class="form-group">
                        <!-- <label >Email</label> -->
