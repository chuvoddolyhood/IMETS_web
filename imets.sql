...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2022 at 06:33 AM
...
(49, 4, 2, '2022-02-27 08:14:38', 268, '2022-02-27 08:16:13', NULL, 0.8, 2, 'Đã khám'),
...
(2, 'Trần Nhân Nghĩa', '2000-01-24', 'Nam', 'Số 40, đường số 3, KDC Thới Nhựt 2, phường An Khánh, quận Ninh Kiều, TP Cần Thơ', '1900', '0939635755', 'GD4929222590774', 4.25, 'trannhannghia.24012000@gmail.com', 'f03bbf95e3e6dd1725ea9aa87ea5b7f1'),
...
(76, 49, 6174, 6174, 0, '2022-05-20', 'Đã thanh toán'),
...
(306, 'Khám ngoại', 'Sáng', '2022-05-18 10:30:00', '2022-05-18 11:00:00', 4, 71, '2022-05-17 04:30:03', ''),
...
(4, 'Võ Thị Thái', '1982-08-04', 'Nữ', 'Nguyễn Đệ, Bình Thủy, Cần Thơ', '312328285', '0939017069', 'Bác sĩ', 7, '2010-07-10', 5, 'thai', '1aafcfcd9efdd2e7ac43e80ce77bba79'),
...
--
ALTER TABLE `appointment`
  MODIFY `ID_Appointment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `diagnose`
  MODIFY `ID_Diagnose` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `evaluation`
  MODIFY `ID_Evaluation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `medicalrecord`
  MODIFY `ID_MedicalRecord` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=320;
...
--
ALTER TABLE `presciption`
  MODIFY `ID_Prescription` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `schedule`
--
ALTER TABLE `schedule`
  MODIFY `ID_schedule` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=314;
